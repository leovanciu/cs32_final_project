...
## Data
A histogram of the simulated data is plotted below. It has mean 100 and standard deviation 17. By construction, it is Normally distributed.

```{r, message = FALSE, eval = TRUE}
library(plotly)
data <- read.csv("Data/data.csv")
hist <- plot_ly(x = data[,2], type = "histogram") %>%
